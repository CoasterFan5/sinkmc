/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 37295945198503234710ccbb626e168a)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	pluginBucket: R2Bucket;
	sinkDB: D1Database;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SINK_INTERNAL_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_REDIRECT_URI">> {}
}
